 ...
 * We used avl tree instead of red-black tree as the run queue data structure of CFS. 
 * 
 * Codes this AVLTree class below are downloaded from:
 ...
 *
 * This AVLTree implement package is used to implement the CFS scheduler for COEN283 Group Project
 * For COEN283 group assignment only. No circulation or dissemination.
 *
 * please refer to license below for more details;
 */
